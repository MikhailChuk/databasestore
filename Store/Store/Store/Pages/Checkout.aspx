    ...
    <div id="content">
        ...
        <div id="errors" data-valmsg-summary="true">
            ...
            <div>
                ...
                <HT:HTML_Input Property="Name" runat="server" />
            </div>

            <h3>Адрес доставки</h3>
            <div>
                <label for="line1">Адрес 1:</label>
                <HT:HTML_Input Property="Line1" runat="server" />
            </div>
            <div>
                <label for="line2">Адрес 2:</label>
                <HT:HTML_Input Property="Line2" runat="server" />
            </div>
            <div>
                <label for="line3">Адрес 3:</label>
                <HT:HTML_Input Property="Line3" runat="server" />
            </div>
            <div>
                <label for="city">Город:</label>
                <HT:HTML_Input Property="City" runat="server" />
            </div>
